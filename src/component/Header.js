            ...
            <header>
                <Container>
                    <div className="in_header_block">
                        {isOpen?(<><div className="logo_hold">
                            <a href="#0">
                            ...
                            <div className="menu_list">
                                <ul className="navbar_nav">
                                    ...
                                    <li className="nav-btn">
                                        ...
                                        <a href="https://github.com/mecollateral/Whitepaper" target="_blank" rel="noreferrer">
                                            Whitepaper
                                        </a>
                                    </li> 
                                    {/* <li className="nav-btn"> */}
                                    ...
                                    <li>
                                        ...
                                        <li>
                                         <a href="https://github.com/mecollateral" target="_blank" rel="noreferrer">
                                         <svg width="22" height="22" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 0C5.373 0 0 5.373 0 12c0 5.305 3.438 9.8 8.209 11.385.6.11.793-.26.793-.577 0-.287-.01-1.045-.015-2.052-3.338.724-4.042-1.615-4.042-1.615-.546-1.385-1.334-1.753-1.334-1.753-1.091-.745.083-.73.083-.73 1.207.085 1.84 1.237 1.84 1.237 1.07 1.834 2.809 1.304 3.494.999.108-.775.42-1.305.763-1.605-2.675-.305-5.491-1.334-5.491-5.93 0-1.313.47-2.38 1.236-3.22-.124-.305-.536-1.524.117-3.176 0 0 1.007-.322 3.3 1.23.957-.266 1.982-.399 3.002-.405 1.02.006 2.046.14 3.004.405 2.291-1.552 3.296-1.23 3.296-1.23.656 1.652.243 2.871.119 3.176.77.84 1.235 1.907 1.235 3.22 0 4.607-2.82 5.622-5.497 5.92.432.372.82 1.102.82 2.22 0 1.606-.015 2.898-.015 3.291 0 .32.193.694.8.576C20.565 21.795 24 17.305 24 12c0-6.627-5.373-12-12-12z" fill="currentColor"/>
                                         </svg>
                                          </a>
                                             </li>
                                    <li className="nav-btn">
