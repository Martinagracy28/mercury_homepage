      ...
      <div className='Pool_Page_main swap_page_main'>
        ...
        <div className='app_page '>
          <h2 className='Dashboard_heading'>
            {/* ME Collateral */}
                        ...
                        <div className='display_bal' style={{'paddingLeft':'10px'}}>
                          <h6>Balance</h6> 
                        <h7>{parseFloat(gbalances.me).toFixed(4)}</h7>
                        ...
                        <h6>24Hours Lock</h6>
                            <h7>Transact {`>=`} {parseFloat((gbalances.me)*0.0075).toFixed(4)}</h7>
                        </div>
                            <div>
                        </div>
                            </div>
                        ...
                        <div className='display_bal'>
                            <h6>12Hours Lock</h6>
                            <h7>Transact {`>=`} {parseFloat((gbalances.me)*0.005).toFixed(4)}</h7>
                        </div>
                            <div>
                        </div>
                            </div>
                        ...
                        <div className='display_bal'>
                        <h6>No lock</h6>
                        <h7>Transact {`<=`} {parseFloat((gbalances.me)*0.0049).toFixed(4)}</h7>
                    </div>
                            <div>
                        </div>
                            </div>
          ...
          <div >
                            ...
                            <h5 className="mb-3" style={{'padding-left':'20px'}}>{isConnected ? secondsLeftState > 0 ? 'Time until wallet unlocks' : 'Wallet access granted' : "Connect your wallet"}</h5>
  ...
  <div style={{ fontSize: 12, marginTop: '50px' }}>
    <strong>77%</strong> mate
          ...
          <div className='display_bal' style={{'text-align': 'justify','padding-left': '20px'}}>
                          ...
                          {secondsLeftInTextState && <Timer count={secondsLeftInTextState? secondsLeftInTextState:'0'} phrase={'good'}/>}      */}
                           <h7 className="mb-3" ><span className="dot" style={{backgroundColor: '#a01ded'}}></span> ETH Balance: ${formatValues(parseFloat((gbalances.eth*EthPrice)/1e18),2)} </h7>
                           <br/>
                           <h7 className="mb-3" ><span className="dot" style={{backgroundColor: 'white'}}></span> ME Balance: ${parseFloat(MePrice)? (parseFloat(parseFloat(gbalances.me)*parseFloat(MePrice))).toFixed(3) :'0'} </h7>
                        </div>
                        <div className="ms-auto mobile_views " style={{"padding": "75px 15px 50px 15px"}}>
  ...
  <div style={{ fontSize: 12, marginTop: '50px' }}>
    <strong>77%</strong> mate
            ...
            <div className="mb-4 pt-4">
                <Table responsive striped hover style={{ backgroundColor: 'rgba(36, 72, 101, 0.1)', border: '1px solid #a01ded', color: 'white' ,borderRadius: '12px',borderCollapse:'separate'}}>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        {Array.isArray(jokerTransactions) && jokerTransactions.length ? (
                            ...
                            <tr>
                                <td colSpan="7" className="text-center"><h3 className="text-gray" style={{color:'white'}}>Data not found</h3></td>
                            </tr>
                        }
